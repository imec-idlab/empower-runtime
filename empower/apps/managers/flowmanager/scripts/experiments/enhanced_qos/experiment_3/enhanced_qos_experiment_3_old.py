...
scp.put('mgen/sandbox/enhanced_qos/experiment_3/flow1.mgn', recursive=True, remote_path='/home/pi/mgen_scripts/')
scp.close()
ssh.close()
print("STA1 - Done!")
...
scp = SCPClient(ssh.get_transport())
scp.put('mgen/sandbox/enhanced_qos/experiment_3/flow2.mgn', recursive=True, remote_path='/home/pi/mgen_scripts/')
scp.close()
ssh.close()
print("STA2 - Done!")
...
scp = SCPClient(ssh.get_transport())
scp.put('mgen/sandbox/enhanced_qos/experiment_3/flow3.mgn', recursive=True, remote_path='/home/pi/mgen_scripts/')
scp.close()
ssh.close()
print("STA3 - Done!")
