...
parser.add_option("", "--controller_ip", type="string", default="10.10.133.51")  # e.g., the Empower controller
#parser.add_option("", "--tenant_id", type="string", default="8aaca1c6-bf3c-4455-8c6d-4e4b6eef7719")  # e.g., 25b33e11-9b2f-49b9-bcfa-aa9d5c4fd76d
parser.add_option("", "--tenant_id", type="string", default="25b33e11-9b2f-49b9-bcfa-aa9d5c4fd76d")  # e.g., 25b33e11-9b2f-49b9-bcfa-aa9d5c4fd76d
...
curl_terminal_command = ['curl', '-X', 'PUT', '-d', '@configs/' + str(options.json_config_file),
                         ...
                         '/components/empower.apps.managers.macmanager.macmanager']
