...
parser = OptionParser()
parser.add_option("", "--json_config_file", type="string", default="tx_config.json")  # filename
...
curl_terminal_command = ['curl', '-X', 'PUT', '-d', '@configs/' + str(options.json_config_file),
                         ...
                         '/components/empower.apps.managers.txpolicymanager.txpolicymanager']
print(curl_terminal_command)
