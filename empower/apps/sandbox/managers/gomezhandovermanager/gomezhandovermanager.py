...
"""Sandbox Gomez handover manager APP."""
...
class GomezHandoverManager(EmpowerApp):
    ...
    Example:
        ...
        ./empower-runtime.py apps.sandbox.managers.gomezhandovermanager.gomezhandovermanager \
    ...
    def __init__(self, **kwargs):
        ...
        self.__gomez_handover_manager = {
            'message': 'Sandbox Gomez handover manager is online!',
            'wtps': {},
        }
