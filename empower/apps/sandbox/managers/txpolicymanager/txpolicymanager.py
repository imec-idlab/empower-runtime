...
class TxPolicyManager(EmpowerApp):
    ...
    Example:
        ...
        ./empower-runtime.py apps.sandbox.managers.txpolicymanager.txpolicymanager \
    ...
    def __init__(self, **kwargs):
        ...
        self.__tx_policy_manager = {"message": "Sandbox TX policy Manager is online!", 'ht_mcs': self.__ht_mcs}
