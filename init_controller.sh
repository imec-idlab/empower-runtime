...
#./empower-runtime.py apps.managers.handovermanager.handovermanager --tenant_id=$TENANT_ID apps.managers.txpolicymanager.txpolicymanager --tenant_id=$TENANT_ID apps.managers.lvapmanager.lvapmanager --tenant_id=$TENANT_ID apps.managers.slicemanager.slicemanager --tenant_id=$TENANT_ID apps.managers.macmanager.macmanager --tenant_id=$TENANT_ID apps.managers.flowmanager.flowmanager --tenant_id=$TENANT_ID apps.managers.adaptiveslicemanager.adaptiveslicemanager --tenant_id=$TENANT_ID --minimum_quantum=$MINIMUM_QUANTUM --maximum_quantum=$MAXIMUM_QUANTUM --quantum_decrease_rate=$QUANTUM_DECREASE_RATE --quantum_increase_rate=$QUANTUM_INCREASE_RATE --db_monitor=$DB_MONITOR apps.managers.mcdahandovermanager.fullmcdahandovermanager --tenant_id=$TENANT_ID --descriptor=$MCDA_DESCRIPTOR --db_monitor=$DB_MONITOR apps.handlers.lvapstatshandler --tenant_id=$TENANT_ID --db_monitor=$DB_MONITOR apps.handlers.wifistatshandler --tenant_id=$TENANT_ID --db_monitor=$DB_MONITOR apps.handlers.ncqmstatshandler --tenant_id=$TENANT_ID --db_monitor=False apps.handlers.ucqmstatshandler --tenant_id=$TENANT_ID --db_monitor=False apps.handlers.binstatshandler --tenant_id=$TENANT_ID --db_monitor=$DB_MONITOR  apps.handlers.slicestatshandler --tenant_id=$TENANT_ID --db_monitor=$DB_MONITOR apps.managers.adaptivelvapmanager.adaptivelvapmanager --tenant_id=$TENANT_ID --minimum_bw=$MINIMUM_BW --maximum_bw=$MAXIMUM_BW --bw_decrease_rate=$BW_DECREASE_RATE --bw_increase_rate=$BW_INCREASE_RATE --db_monitor=$DB_MONITOR

# Delay-aware MCDA (User association algorithm only)
#./empower-runtime.py apps.managers.handovermanager.handovermanager --tenant_id=$TENANT_ID apps.managers.txpolicymanager.txpolicymanager --tenant_id=$TENANT_ID apps.managers.lvapmanager.lvapmanager --tenant_id=$TENANT_ID apps.managers.slicemanager.slicemanager --tenant_id=$TENANT_ID apps.managers.macmanager.macmanager --tenant_id=$TENANT_ID apps.managers.flowmanager.flowmanager --tenant_id=$TENANT_ID apps.managers.mcdahandovermanager.fullmcdahandovermanager --tenant_id=$TENANT_ID --descriptor=$MCDA_DESCRIPTOR --db_monitor=$DB_MONITOR apps.handlers.lvapstatshandler --tenant_id=$TENANT_ID --db_monitor=$DB_MONITOR apps.handlers.wifistatshandler --tenant_id=$TENANT_ID --db_monitor=$DB_MONITOR apps.handlers.ncqmstatshandler --tenant_id=$TENANT_ID --db_monitor=False apps.handlers.ucqmstatshandler --tenant_id=$TENANT_ID --db_monitor=False apps.handlers.binstatshandler --tenant_id=$TENANT_ID --db_monitor=$DB_MONITOR  apps.handlers.slicestatshandler --tenant_id=$TENANT_ID --db_monitor=$DB_MONITOR

# Delay-aware MCDA + slicing APPs
#./empower-runtime.py apps.managers.handovermanager.handovermanager --tenant_id=$TENANT_ID apps.managers.txpolicymanager.txpolicymanager --tenant_id=$TENANT_ID apps.managers.lvapmanager.lvapmanager --tenant_id=$TENANT_ID apps.managers.slicemanager.slicemanager --tenant_id=$TENANT_ID apps.managers.macmanager.macmanager --tenant_id=$TENANT_ID apps.managers.flowmanager.flowmanager --tenant_id=$TENANT_ID apps.managers.adaptiveslicemanager.adaptiveslicemanager --tenant_id=$TENANT_ID --minimum_quantum=$MINIMUM_QUANTUM --maximum_quantum=$MAXIMUM_QUANTUM --quantum_decrease_rate=$QUANTUM_DECREASE_RATE --quantum_increase_rate=$QUANTUM_INCREASE_RATE --db_monitor=$DB_MONITOR apps.managers.mcdahandovermanager.fullmcdahandovermanager --tenant_id=$TENANT_ID --descriptor=$MCDA_DESCRIPTOR --db_monitor=$DB_MONITOR apps.handlers.lvapstatshandler --tenant_id=$TENANT_ID --db_monitor=$DB_MONITOR apps.handlers.wifistatshandler --tenant_id=$TENANT_ID --db_monitor=$DB_MONITOR apps.handlers.ncqmstatshandler --tenant_id=$TENANT_ID --db_monitor=False apps.handlers.ucqmstatshandler --tenant_id=$TENANT_ID --db_monitor=False apps.handlers.binstatshandler --tenant_id=$TENANT_ID --db_monitor=$DB_MONITOR  apps.handlers.slicestatshandler --tenant_id=$TENANT_ID --db_monitor=$DB_MONITOR

# Experiment Gomez (IM 2020 and current)
#./empower-runtime.py apps.managers.handovermanager.handovermanager --tenant_id=$TENANT_ID apps.managers.txpolicymanager.txpolicymanager --tenant_id=$TENANT_ID apps.managers.lvapmanager.lvapmanager --tenant_id=$TENANT_ID apps.managers.slicemanager.slicemanager --tenant_id=$TENANT_ID apps.managers.macmanager.macmanager --tenant_id=$TENANT_ID apps.managers.flowmanager.flowmanager --tenant_id=$TENANT_ID apps.managers.gomezhandovermanager.gomezhandovermanager --tenant_id=$TENANT_ID apps.handlers.lvapstatshandler --tenant_id=$TENANT_ID --db_monitor=$DB_MONITOR apps.handlers.wifistatshandler --tenant_id=$TENANT_ID --db_monitor=$DB_MONITOR apps.handlers.ncqmstatshandler --tenant_id=$TENANT_ID --db_monitor=False apps.handlers.ucqmstatshandler --tenant_id=$TENANT_ID --db_monitor=False apps.handlers.binstatshandler --tenant_id=$TENANT_ID --db_monitor=$DB_MONITOR  apps.handlers.slicestatshandler --tenant_id=$TENANT_ID --db_monitor=$DB_MONITOR
