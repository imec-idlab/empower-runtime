...
# No WiFi Slicing
./empower-runtime.py apps.sandbox.managers.txpolicymanager.txpolicymanager --tenant_id=$TENANT_ID apps.managers.slicemanager --tenant_id=$TENANT_ID apps.managers.macmanager --tenant_id=$TENANT_ID apps.sandbox.managers.flowmanager.flowmanager --tenant_id=$TENANT_ID apps.sandbox.managers.mcdamanager.mcdamanager --tenant_id=$TENANT_ID --descriptor=$MCDA_DESCRIPTOR --db_monitor=True apps.handlers.lvapstatshandler --tenant_id=$TENANT_ID --db_monitor=True apps.handlers.wifistatshandler --tenant_id=$TENANT_ID --db_monitor=True apps.handlers.ncqmstatshandler --tenant_id=$TENANT_ID --db_monitor=True apps.handlers.ucqmstatshandler --tenant_id=$TENANT_ID --db_monitor=True apps.handlers.binstatshandler --tenant_id=$TENANT_ID --db_monitor=True  apps.handlers.slicestatshandler --tenant_id=$TENANT_ID --db_monitor=True
