...
# Stats only
./empower-runtime.py apps.handlers.lvapstatshandler --tenant_id=$TENANT_ID --db_monitor=True apps.handlers.wifistatshandler --tenant_id=$TENANT_ID --db_monitor=True apps.handlers.ncqmstatshandler --tenant_id=$TENANT_ID --db_monitor=True apps.handlers.ucqmstatshandler --tenant_id=$TENANT_ID --db_monitor=True apps.handlers.binstatshandler --db_monitor=True --tenant_id=$TENANT_ID apps.handlers.slicestatshandler --tenant_id=$TENANT_ID --db_monitor=True
